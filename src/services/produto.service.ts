...
export class ProdutoService {
  ...
  async criar(nome: string, descricao: string, preco: number, categoriaId: number, imagem?: string) {
    const produto = Produto.criar(nome, descricao, preco, categoriaId, imagem);
