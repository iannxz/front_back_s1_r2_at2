...
export class ProdutoRepository {
  ...
  async create(dados: Omit<Iproduto, 'id'>): Promise<ResultSetHeader> {
    const sql = "INSERT INTO produtos (nomeprod, descricao, valor, imagem, idcategoria) VALUES (?, ?, ?, ?, ?);";
    const values = [dados.Nome, dados.Descricao, dados.Preco, dados.Imagem, dados.CategoriaId];
